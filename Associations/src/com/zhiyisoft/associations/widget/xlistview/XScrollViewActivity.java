 ...
 * @date 2013-10-08
 */
public class XScrollViewActivity extends Activity implements
	...
	protected void initView() {
		...
		View content = LayoutInflater.from(this).inflate(
				R.layout.vw_scroll_view_content, null);
		...
		if (null != content) {
			...
			mAdapter = new ArrayAdapter<String>(this, R.layout.vw_list_item,
					mItems);
