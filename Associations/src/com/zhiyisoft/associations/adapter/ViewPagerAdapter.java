...
import com.zhiyisoft.associations.widget.ViewPagerItemView;
...
public class ViewPagerAdapter extends PagerAdapter {
	...
	public ViewPagerAdapter(Context context, int[] arrays) {
		this.mContext = context;
		this.mResArray = arrays;
	...
	public Object instantiateItem(View container, int position) {
		...
		if (mHashMap.containsKey(position)) {
			...
			itemView.setData(mResArray[position]);
